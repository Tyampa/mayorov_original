...
from std_msgs.msg import Int8    # тип сообщения — строка
...
class Listener(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Узел переполнения сработал!")
    ...
    def callback(self, msg):
        ...
        self.get_logger().info(f"!!!ПЕРЕПОЛНЕНИЕ!!! ПОлучено значение: {msg.data}")
